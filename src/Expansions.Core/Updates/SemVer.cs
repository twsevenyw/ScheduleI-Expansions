...
/// </para>
/// <para>
/// Build metadata (<c>+abc123</c>) is stripped rather than compared, per the specification — the .NET
...
internal readonly struct SemVer : IComparable<SemVer>, IEquatable<SemVer>
{
    ...
    /// <summary>
    /// SemVer §11.3–11.4: a pre-release version is lower than the release it precedes, identifiers are
